...
if not exist dependency-check (
    call ..\req\wget.exe https://github.com/jeremylong/DependencyCheck/releases/download/v6.0.3/dependency-check-6.0.3-release.zip
...
call move "dependency-check\bin\dependency-check-report.html" "../../target"
